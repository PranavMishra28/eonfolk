...
| R-004 | Medium | Major | Sparse Pixi, the fixed-camera PlayCanvas diorama, and frozen `afdc6e0`/`17b2a3d` candidates were release-invalidated. The final targeted confirmation against `90c0ad2` answered the exact World-as-Product question **YES** with zero P0/P1 after proving truthful opening lifetime, consequence staging, Chronicle framing, cadence, task release, travel continuity, and event-time focus. Canonical repeated performance and unfamiliar-human evidence remain open [S-WP-014] [S-WP-022] [S-WAP-001] [S-WAP-012]. | Visual/product owner: preserve the exact confirmed Reality-owned choreography and unchanged meaningful-world predicate; require clean DEEP/zero-egress evidence and keep Gate 0/A/B `NOT RUN` until humans execute them. Reopen before adding population, Recast, assets, or a second renderer if canonical budgets or human legibility fail. | D-008 |
