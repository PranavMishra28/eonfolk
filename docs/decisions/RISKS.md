...
| R-004 | High | Major | Sparse Pixi was release-invalidated. PlayCanvas passed the bounded spike and current automated temporal/browser probes, but independent human presence and fresh clean 15-run evidence remain open [S-WP-014]. | Visual owner: world-dominant composition, full-limbed rigs, visible props/interaction, authored paths, semantic parity, fixed degradation order, and conditional pruned KayKit fallback. | D-008 |
