...
| R-004 | High | Major | Sparse Pixi and the fixed-camera PlayCanvas diorama were both release-invalidated. The frozen hostile baseline answered the exact World-as-Product question NO: incoherent scale, invented cyclic activity, no camera/selection hierarchy, dashboard composition, and detached Chronicle were P1 blockers. The current continuous-world correction and canonical repeated performance evidence remain open [S-WP-014] [S-WP-022] [S-WAP-001] [S-WAP-012]. | Visual/product owner: Reality-owned travel/task/slots, coherent metre scale, natural context, three semantic camera bands, direct selection, world-dominant contextual UI, Chronicle spatial focus, semantic parity, fixed degradation order, and exact fresh YES review. Cut breadth before adding population, Recast, assets, or a second renderer. | D-008 |
