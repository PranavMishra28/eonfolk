...
| 4 | R-004 Embodied Riverhold still feels sparse, mechanical, or too heavy | Independent inhabited/alive verdict is NO, task recognition fails, or fresh clean budgets miss after one bounded pass | Fix composition/action staging, then test the reviewed asset fallback or reopen renderer scope |
...
| R-004 | High | Major | Sparse Pixi was release-invalidated. PlayCanvas passed the bounded spike and exact clean integration checkpoint, but independent human presence and the canonical repeated 15-run performance evidence remain open [S-WP-014] [S-WP-022]. | Visual owner: world-dominant composition, full-limbed rigs, visible props/interaction, authored paths, semantic parity, fixed degradation order, and conditional pruned KayKit fallback. | D-008 |
