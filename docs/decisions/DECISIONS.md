...
**Remaining uncertainty.** Eight procedural inhabitants may still feel like pieces on a larger board; direct canvas selection, semantic zoom, task choreography, close-follow readability, and Chronicle spatial focus still require exact browser evidence. Real mid-tier mobile/GPU/thermal behavior remains unmeasured, and the required independent answer—“Does this feel like watching real inhabitants of a place, rather than looking at a visualization of a simulation?”—is not yet **YES**. KayKit CC0 assets remain a conditional reviewed fallback, not a default dependency or committed payload [S-WP-015] [S-WP-016] [S-WP-021].
