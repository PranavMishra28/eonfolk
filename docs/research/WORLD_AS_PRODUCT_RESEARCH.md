...
|---|---|---|---:|---|---|---|
| S-WAP-001 | Maxis presented GlassBox through the principle that visible game activity reports to the underlying simulation | [EA: SimCity Insider's Look—GlassBox](https://www.ea.com/en-gb/news/inside-simcity-glassbox-game-revealed) | A | High for the stated design principle; not independent quality evidence | This research; design; frontend | Reopen only if used to justify a literal architecture beyond the source |
