...
| React best practices | `openai-curated-remote/vercel/0.21.4`, `skills/react-best-practices/SKILL.md` | `64cbd5962d4a6005e55503138c29930053d55dacc6290e60bad22ebeebca5fca` | No standalone package license file found | Review the multi-component React player surface for bundle, rendering, state, and accessibility risks | Read-only local instructions; grants no code, network, deployment, or account authority | 2026-08-21 |
