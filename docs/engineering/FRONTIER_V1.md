...
- Slice 6 remainder: GLB still unused (payload). Follow indoor is locked for Workshop, Dawnmere meeting-hall, mill-scale, storehouse, and shared-dwelling envelopes. Headed Play framed citizen-05 in the hall and citizen-06 in the shared dwelling. Dawnmere has no mill building to Follow. No citizen entered the storehouse envelope in headed Play across origin plus four Faster live days, so storehouse occupancy Follow is not a headed proof.
