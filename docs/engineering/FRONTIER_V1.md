...
| Projects / institutions / migration | SHALLOW (seeded expedition, fixed chain) | Citizen-originated water-reserve from standing plan + need, then completed by Reality (not forever proposed); institutions/migration still the seeded chain |
...
- Originating other citizen project kinds besides water-reserve remains open.
...
- Recurring live-day Standard Brain inside Play timing budgets remains UNRESOLVED.
