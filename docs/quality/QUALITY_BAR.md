...
The named build shows eight Standard-Brain citizens, three resources, four legible behavior families, one story-relevant exchange/repair loop, and one two-citizen interaction that changes authoritative state. Five silent unfamiliar observers review the same seed/time without raw log or narration. At least three of five identify three activities and the interaction. At least four of five find **Follow Mara** in ten seconds and understand she is not directly controlled. Semantic mode must preserve identical facts/actions. No external model or network is present.
