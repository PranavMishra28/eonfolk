...
Only an authorized human operator can supply the unfamiliar-participant manifests through `/Users/pranav/Documents/ChatGPT/.eonfolk-evidence-inbox/001/`; the Goal prompt owns exact filename, size/schema/sign-off validation and evidence-only/checkpoint import commits. Codex may prepare builds/scripts and continue non-human work after Gate 0, but cannot recruit, impersonate, fabricate, or substitute planning personas. Without operator-supplied Gate 0 evidence, implementation stops before foundations; without Gate A/B manifests, those gates remain unpassed.
