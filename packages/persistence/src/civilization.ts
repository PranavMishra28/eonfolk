...
export const RELEASE_GENESIS_CIVILIZATION_STATE_VERSION =
	"eonfolk-release-genesis-civilization-state-v1" as const;
export const RELEASE_GENESIS_CIVILIZATION_TRANSITION_VERSION =
	"eonfolk-release-genesis-civilization-transition-v1" as const;
export const RELEASE_GENESIS_CIVILIZATION_ENGINE_VERSION =
	"eonfolk-release-genesis-civilization-engine-v1" as const;
...
const SOURCE_EXPERIMENT_VERSION = "eonfolk-civilization-experiment-v2" as const;
const SOURCE_RUNNER_VERSION = "eonfolk-civilization-runner-v2" as const;
const SOURCE_EVENT_VERSION =
	"eonfolk-civilization-experiment-event-v2" as const;
const SOURCE_STEP_VERSION = "eonfolk-civilization-experiment-step-v2" as const;
...
async function validateCheckpoint(
	...
	const sourceStateHash = await sourceDomainHash(
		"EONFOLK:CIVILIZATION-EXPERIMENT-STATE:v2",
