...
export const LOGICAL_TIMELINE = Object.freeze([
	...
	Object.freeze({
		atMs: 10_000,
		kind: "follow-mara-deadline",
		comparison: "raw-elapsed-lte",
	}),
	Object.freeze({
		atMs: 60_000,
		kind: "observer-prompt",
		comparison: "first-frame-gte",
		deliveryLatestMs: 61_000,
	}),
	Object.freeze({
		kind: "endpoint",
