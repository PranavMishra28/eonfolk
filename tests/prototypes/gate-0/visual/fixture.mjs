...
export const ACTIVITY_FAMILIES = freeze([
	...
	freeze({
		id: "activity:exchange-rations",
		label: "exchanging wood and rations",
	}),
...
export const CITIZENS = freeze([
	freeze({
		id: "citizen:mara",
		name: "Mara",
		activityId: "activity:carry-water",
		activity: "carrying water to the market tally",
		prop: "blue water jug",
		salient: true,
	}),
	freeze({
		id: "citizen:toma",
		name: "Toma",
		activityId: "activity:exchange-rations",
		activity: "exchanging wood and rations with Iven",
		prop: "ration bundle",
	}),
	freeze({
		id: "citizen:iven",
		name: "Iven",
		activityId: "activity:exchange-rations",
		activity: "exchanging wood and rations with Toma",
		prop: "forked wood bundle",
	}),
	freeze({
		id: "citizen:sera",
		name: "Sera",
		activityId: "activity:carry-water",
		activity: "carrying water from the well",
		prop: "blue bucket",
	}),
	freeze({
		id: "citizen:nadi",
		name: "Nadi",
		activityId: "activity:gather-wood",
		activity: "gathering wood by the north path",
		prop: "forked sticks",
	}),
	freeze({
		id: "citizen:owen",
		name: "Owen",
		activityId: "activity:gather-wood",
		activity: "gathering wood near the mill",
		prop: "wood bundle",
	}),
	freeze({
		id: "citizen:bela",
		name: "Bela",
		activityId: "activity:carry-water",
		activity: "carrying water toward the bridge",
		prop: "blue jug",
	}),
	freeze({
		id: "citizen:corin",
		name: "Corin",
		activityId: "activity:gather-wood",
		activity: "gathering wood beside the woodpile",
		prop: "forked sticks",
	}),
]);
...
export const MARA_PROJECTION = freeze({
	...
	standingPlan:
		"Standing Plan: check Iven's tally, then decide what to tell Toma.",
...
export const MARA_TOMA_CUE = freeze({
	...
	label:
		"Mara and Toma compare the market tally; their concern remains unresolved.",
