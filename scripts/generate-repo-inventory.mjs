...
export function renderRepositoryInventory(files, root = ROOT) {
	...
	const lines = [
		...
		"",
		`The tree contains ${riverholdPaths.length} path names containing \`Riverhold\` or \`Founder Alpha\`. They are compatibility, historical, or Founder Alpha regression material. Their browser screenshots, traces, renderer probes, and verification artifacts are **INELIGIBLE FOR V1 READINESS** and cannot satisfy a V1 row in [GOAL.md](../../GOAL.md).`,
		"",
