...
export function renderRepositoryInventory(files, root = ROOT) {
	...
	const lines = [
		...
		"",
		`The repository contains ${riverholdPaths.length} path names containing \`Riverhold\` or \`Founder Alpha\`. Current application paths may use Riverhold as the canonical settlement name; Founder Alpha review records are historical evidence and cannot satisfy a current V1 row in [GOAL.md](../exec-plans/completed/GOAL.md).`,
		"",
