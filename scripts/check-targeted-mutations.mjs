...
const mutants = [
	...
	{
		name: "world focus accepts extra authority parameters",
		file: "apps/web/src/research-navigation.ts",
		from: "[...parameters].length !== exactParameters.length ||",
		to: "false ||",
		tests: ["apps/web/src/remaining-product-navigation.test.ts"],
	},
	{
		name: "Research evidence accepts a detached snapshot state",
		file: "apps/web/src/research-evidence.ts",
		from: "snapshot.stateHash === baseEvent.postStateHash",
		to: "true",
		tests: ["apps/web/src/remaining-product-research-evidence.test.ts"],
	},
	{
...
execFileSync(
	...
	[
		...
		"apps/web/src/remaining-product-navigation.test.ts",
		"apps/web/src/remaining-product-research-evidence.test.ts",
		"--reporter=dot",
	],
